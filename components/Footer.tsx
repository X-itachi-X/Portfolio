...
const Footer = () => {
  return (
    <footer className='w-full pt-20 pb-10' id='contact'>
        <div className='w-full absolute left-0 -bottom-[-0vh] min-h-96'>
        ...
        <div className='flex flex-col items-center'>
            ...
            <a href='mailto:ankitxdev@gmail.com'>
                <MagicButton 
        ...
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
            <p className='md:text-base text-sm  md:font-normal font-light'>Copyright © 2024 Ankit</p>
